...
- — for the term's role inside a specific method — the `design-by-efferent` package's vocabulary
- where solubility is the target of generation and a known hinge
