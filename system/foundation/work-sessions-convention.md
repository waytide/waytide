...
**Under a project's creative mode the artifact is an aspiration**, in `waytide/local/aspiration/`, and everything in this section holds for it unchanged — the mode changes the vocabulary and the directory and no obligation (see the a-project-works-in-formal-or-creative-mode rule). The section is written in the formal mode's terms because formal is the default; read *design* as *aspiration* throughout it in a creative project.
