...
- the a-time-value-carries-minutes-and-seconds rule — the time's resolution - the rules-convention. The rule format - the file-names rule. The UTC filename prefix this contrasts with
