...
- the human-in-the-loop TDD rule - the show-the-test-after-implementing rule -. For a Ruby project. The `code/ruby` rule naming the suite's entry point and its verified output
