...
This is how the highest-leverage hinge is handed over for deliberation, that hinge being the efferent shape of the actuation. The engineer compares concrete alternatives. An always-open escape into dictation or dialogue covers the case where the right shape is not among the options.
...
Offer them through the selection UI, which supplies the free-text option. Do not add an escape option of your own. See the present-every-prompt rule.
