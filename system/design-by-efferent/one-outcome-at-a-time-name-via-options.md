...
**The naming gate offers candidate names, and the free-text option among them.** Responsibility transfers there exactly as it does at the actuation gate (see the actuation-gate-options rule). Present a list of candidate outcome-context names. The escape lets the human input a name directly or discuss it.
