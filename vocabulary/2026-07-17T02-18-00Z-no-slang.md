...
Names, prose, comments, commit messages — **and conversation with the user** — use literal, non-slang terms. The no-slang standard governs phrasing addressed *to* the human, not only what lands in the codebase: the mindset it protects lives in the person, so it reaches conversation, not just the artifact.
