...
**Why:** "Happy path" is imported jargon with an affective metaphor (the path is not *happy*); "normal path" is the literal description — the normal course versus the error/exceptional cases. Consistent with the name-literally-not-by-analogy rule (`agent/rules/terminology/2026-06-26T19-55-19Z-name-literally-not-by-analogy.md`): prefer the plain literal term over a coined metaphor.
