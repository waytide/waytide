...
> Rule 1.6 permits the noun, and Rule 1.12 permits a verb that fits one of four technical verb
> categories. What survives here is the verb use of a word whose noun is permitted.
...
**The permission has two halves and they are not symmetrical.** Rule 1.6 permits a word that is not
approved when it is a technical noun, and Rule 1.5 gives **twenty-two** noun categories. Rule 1.12
...
the strength of their raw dictionary status. As nouns they are permitted by Rule 1.6, and the rules
