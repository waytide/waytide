...
investigation. It records the gap and the constraint on closing it; it settles nothing. It is
promoted once it is decided which package ships the script, or that none does and the rule is
reworded.
