...
investigation. It records a contradiction between three rules currently in force; it settles
nothing. It is promoted once it is decided which derivation is correct and the other rules are
conformed to it.
