...
investigation. It records what the files say; it settles nothing. It is promoted once the
decision is made about where a test runner belongs and whether `git`'s standalone claim is
corrected or its cross-package references are removed.
