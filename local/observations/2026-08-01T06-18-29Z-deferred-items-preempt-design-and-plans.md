...
**Status:** a working hypothesis under discovery. It records a pattern in how this repository
actually accumulates work, and a consequence of the deferred convention that follows from it.
It proposes no change. It is promoted once it is decided whether design and plan are meant to
carry this work, whether the deferred convention should preserve what a resolved item held, or
