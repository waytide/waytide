...
investigation. It records the shape of the problem, not a proposed bound. It is promoted once
it is decided whether a bound is stated, what it is, and what the rule says when output would
exceed it.
