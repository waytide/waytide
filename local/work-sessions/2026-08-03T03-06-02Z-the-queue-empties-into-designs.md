...
The human's level of participation is chosen at a feature's or experiment's initiation, beside the working
...
- **cycle** — one traversal of the loop: a hinge surfaced, decided, acted on. The unit a loop
  ...
  cycle* is the loop.
- **attended / unattended** — the human's level of participation. Whether the loop stops at each hinge for the
