...
never gets it; and the design said nothing about **the human's level of participation**, now a second choice at
the same initiation.
...
was**: its six features were begun before the human's level of participation, the current-branch working
