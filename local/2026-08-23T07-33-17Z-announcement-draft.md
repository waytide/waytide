...
• *Five checkpoints* — the call, the proof of the call's effects, the conditions necessary to prove it, the implementation of it, and following clarifications and evolutions
